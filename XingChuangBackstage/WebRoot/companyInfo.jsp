...
<html>
  ...
  <script type="text/javascript">
        ...
        var companyPhone =item.companyPhone;
        var companyAddress =item.companyAddress;
        ...
        $("tr:last").append("<td class='td1'>"+peopleName+"</td>");
        $("tr:last").append("<td class='td2'>"+companyName+"</td>");
        $("tr:last").append("<td class='td3'>"+companyPhone+"</td>");
        $("tr:last").append("<td class='td4'>"+companyAddress+"</td>");
        $("tr:last").append("<td class='td5'>"+userName+"</td>");
        $("tr:last").append("<td class='td6'>"+updateTime+"</td>");
    ...
    function asyModifyInfo(){
            ...
            success:function(data){
                    ...
                    targetTr.find("td.td1").html($("#peopleName").val());
                    targetTr.find("td.td2").html($("#companyName").val());
                    targetTr.find("td.td3").html($("#companyPhone").val());
                    targetTr.find("td.td4").html($("#companyAddress").val());
                    targetTr.find("td.td5").html($("#userName").val());
    ...
    function deleteData(id){
			...
			$("#userName").val(trContent.find("td.td5").html());
    }
	...
	function modifyData(id) {
		...
		//获取值
		var peopleName = trContent.eq(0).find("td.td1").text();
		var companyName = trContent.eq(0).find("td.td2").text();
		var companyPhone = trContent.eq(0).find("td.td3").text();
		var companyAddress = trContent.eq(0).find("td.td4").text();
		var userName = trContent.eq(0).find("td.td5").text();
...
<!--内容部分-->
	...
	<div class="row">
		<div class="col-md-12" style="margin-top:20px;">
			<div class="panel panel-info">
				<div class="panel-heading">企业用户数据</div>
				<table id="table"
	...
	<div class="modal fade" id="modifyModel" tabindex="-1" role="dialog"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="peopleName" class="col-sm-2 control-label">负责人</label>
						<div class="col-sm-10">
        ...
        <div class="form-group">
        <label for="companyPhone" class="col-sm-2 control-label">联系方式</label>
        <div class="col-sm-10">
